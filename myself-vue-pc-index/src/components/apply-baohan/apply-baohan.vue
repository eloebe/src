<template>
	<div>
					...
					<div class="layui-carousel" id="stepForm" lay-filter="stepForm" style="margin: 0 auto;">
						<div class="Box" carousel-item>
									...
									<div class="Box-1" style="height:492px;overflow-y:auto;">
										<div class="layui-form-item">
											...
											<div class="layui-block">
												<input name="applyUser" lay-verify="required" v-model="companyname" type="text" placeholder="请填写申请电子保函的招标企业全称"
												 class="layui-input" />
											</div>
										</div>
										<div class="layui-form-item">
											<div class="layui-inline">
												...
												<div style="width:300px;" class="layui-input-block">
													<select lay-verify="required" name="tradingPlatformName" lay-filter="aihao">
											...
											<div class="layui-inline right">
												...
												<div style="width:300px;" class="layui-input-block">
													<input name="projectTenderer" lay-verify="required" type="text" placeholder="请输入您要申请保函的投标项目招标人" class="layui-input" />
												</div>
											</div>
											<div class="clear"></div>
										</div>
										...
										<div class="layui-form-item">
											<div class="layui-inline">
												...
												<div style="width:300px;" class="layui-input-block">
													<input name="blockName" lay-verify="required" type="text" placeholder="请输入您要申请保函的投标项目标段(包)名称" class="layui-input" />
												</div>
											</div>
											<div class="layui-inline right">
												<label>项目标段（包）编号:<span> *</span></label>
												<div style="width:300px;" class="layui-input-block">
													<input name="blockCode" lay-verify="required" type="text" placeholder="请输入您要申请保函的投标项目标段(包)编号" class="layui-input" />
												</div>
											</div>
											<div class="clear"></div>
										</div>
										...
										<div class="layui-form-item">
											<div class="layui-inline">
												...
												<div style="width:300px;" class="layui-input-block">
													<input name="bidOpenTime" lay-verify="required" type="text" placeholder="请输入您要申请保函的投标项目开标时间" class="layui-input"
													 id="date">
												</div>
											</div>
											<div class="layui-inline right">
												<label>投标保证金金额（元）<span> *</span></label>
												<div style="width:300px;" class="layui-input-block">
													<input name="marginAmount" lay-verify="number" type="text" placeholder="请输入您要申请保函的投标项目标段(包)的保证金额" class="layui-input" />
												</div>
											</div>
											<div class="clear"></div>
										</div>
										...
										<div class="layui-form-item">
											<div class="layui-inline">
												...
												<div style="width:300px;" class="layui-input-block">
													<input maxlength="4" name="applyContactName" lay-verify="required|chinese" type="text" placeholder="请输入您要申请保函的报名人姓名" class="layui-input" />
												</div>
											</div>
											<div class="layui-inline right">
												<label>投标联系人电话<span> *</span></label>
												<div style="width:300px;" class="layui-input-block">
													<input name="applyContactMobile" lay-verify="phone"  autocomplete="on" type="text" placeholder="请输入您要申请保函报名人联系电话" class="layui-input" />
												</div>
											</div>
											<div class="clear"></div>
										</div>
													...
													<p>
														<div class="guarantee-div">
															<div v-for="(cate, index) in categories" :key="index" :data-index="index" @click="changeBorder">
																...
																<div :data-index="index" @click.stop="lookdetails" class="look-details cursor">查看担保方详情</div>
																<input :data-index="index" type="radio" class="yz" name="sex" :value="index" :title="index" lay-verify="checkboxmustbe">
																<!-- <input class="fuxuan" lay-verify="checkboxmustbe" lay-filter="yz"  type="checkbox" name="a" :title="index" lay-skin="primary"> -->
															</div>
														</div>
													</p>
												</div>
											...
											<li v-if="open" class="layui-timeline-item">
												...
												<div class="layui-timeline-content layui-text">
													...
													<div class="layui-input-block" style="width: 300px;">
														<input  lay-verify="required" name="mailAddress" type="text" :placeholder="'请输入您的发票'+address+'地址'" class="layui-input" />
													</div>
												</div>
											</li>
											<li v-if="open" class="layui-timeline-item">
												...
												<div class="layui-timeline-content layui-text">
													...
													<div class="layui-input-block">
														<input  lay-verify="required" name="contactMobile" style="width: 300px;" type="text" placeholder="请输入您的联系电话" class="layui-input" />
														<p v-if="cateCurrentIndex=='number'">
															1、开票信息将与您的企业信息一致<br>
															2、担保机构发票开具时间为固定时间，有疑问请电话联系担保机构：********
														</p>
														<p v-else>
															1、开票信息将与您的企业信息一致<br>
															2、担保机构发票开具时间为固定时间，有疑问请电话联系{{Name}}担保机构：{{phone}}
														</p>
													</div>
												</div>
											</li>
											<li class="layui-timeline-item">
												...
												<div class="layui-timeline-content layui-text">
													...
													<div class="layui-input-block" style="width: 300px;">
														...
														<input  lay-verify="required" name="employeesNumber" type="text" placeholder="请输入企业从业人数" class="layui-input" />
													</div>
												</div>
											</li>
											<li class="layui-timeline-item">
												...
												<div class="layui-timeline-content layui-text">
													...
													<div class="layui-input-block" style="width: 300px;">
														<input name="turnover"  lay-verify="required" type="text" placeholder="请输入企业营业收入" class="layui-input" />
													</div>
												</div>
											</li>
											<li class="layui-timeline-item">
												...
												<div class="layui-timeline-content layui-text">
													...
													<div class="layui-input-block" style="width: 300px;">
														<input name="totalAssets"  lay-verify="required" type="text" placeholder="请输入企业资产总额" class="layui-input" />
													</div>
												</div>
											</li>
										</ul>
							...
							<div style="">
								...
								<form class="layui-form"  style="overflow:visible;margin: 0 auto;">
										...
										<ul class="ul1">
											<li>
												<h2>
													...
													《出具投标保函申请书》
													<a :href="null" target="blank1" class="preview1 preview cursor"><span>下载预览</span></a>
													<div data-cateid="0" @click="signOnline" class="signatrue">
														<span class="cursor">在线签章</span>
													</div>
												</h2>
												<span class="look-instance"><a href="././assets/img/shenqing.png" target="_blank">查看示例</a></span>
											</li>
											<li>
												<h2>
													<img src="@/assets/a.png" />
													《企业征信授权书》
													<a :href="null" target="blank2"  class="preview2  preview cursor"><span>下载预览</span></a>
													<div data-cateid="1" @click="signOnline" class="signatrue">
														<span class="cursor">在线签章</span>
													</div>
													<input lay-verify="signverify" type="text" placeholder="请输入企业营业收入" class="layui-hide layui-input" />
												</h2>
												<span class="look-instance"><a href="././assets/img/shouquan.png" target="_blank">查看示例</a></span>
											</li>
											<li>
												<h2>
													<img src="@/assets/a.png" />
													请上传《企业资质证书》
													<a :href="null" target="blank3" class="previe3 preview cursor"><span>下载预览</span></a>
													<el-upload ref="my-upload" style="width:94px;height:30px;" class="upload-demo signatrue" :action='this.$store.state.Api3+"/file/upload"'
													 :on-success="aftersuccess" :limit="1">
														<el-button @click="repplay" style="line-height:0;background: #19AECF;width:94px;height:30px;border-radius:none;border:none;"
														 size="" type="primary">{{view3}}</el-button>
													</el-upload>
												</h2>
												<span class="look-instance"><a href="././assets/img/zizhi.png" target="_blank">查看示例</a></span>
											</li>
										</ul>
									</div>
									<hr />
		...
		<div id="layer122" style="display: none;overflow: hidden;">
			<div class="layer-div">
				<h3 class="">请插入Ukey校验企业名称</h3>
				<div class="square">
				</div>
		...
		<div id="needknow" style="height: 100%;display: none;">
			<applyneedknow :konwlayer2="konwlayer2"></applyneedknow>
		</div>
		<aboutgansu id="layer111"  style="display:none;height: 100%;"></aboutgansu>
		<abouthanhua id="layer112"  style="display:none;height: 100%;"></abouthanhua>
...
<script>
	...
	import aboutgansu from '@/components/apply-baohan/about_gansu.vue';
	import abouthanhua from '@/components/apply-baohan/about_hanhua.vue';
	import applyneedknow from '@/components/apply-baohan/applyneedknow.vue';
	...
	export default {
		...
		data() {
			return {
				...
				view3:'点击上传',
				href1:null,
				// var applyurl2 = localStorage.getItem('applyurl');
				href2:null,
				href3:null,
				Name:'',
				phone:'',
		 ...
		 computed:{
			 ...
			 konwlayer2(){
			     return this.konwlayer
			 }
		},
		created(){
			sessionStorage.removeItem('applyurl');
			sessionStorage.removeItem('allowpowerurl');
		},
		mounted() {
			//隐藏已上传文件列表
			$('.el-upload-list').hide();
			...
			// Lay.WeAdminEdit(false,'#needknow',null,972,600,that,null,0)
			//获取当前日期后三个工作日的日期
			...
			layui.use(['jquery', 'element', 'step', 'form', 'laydate', 'layer'], function() {
				...
				// Lay.WeAdminEdit('关于瀚华担保','#layer112',null,1,1)
				...
				signverify: function(value) {
					if (!$(".preview2").is(":visible")||!$(".preview1").is(":visible")) {
						return "请完善签章";
					}
				},
                // chinese:[/[^\u4E00-\u9FA5]/g,'hanzi'],
				...
				console.log(com)
				 ...
				 ()=>{
				if(com=='null'||com==null||com==undefined||com=='undefined'||com==''){
				 }else{
				...
				form.on('submit(formStep4)', function(data) {
					...
					// console.log(opp)
					var applyurl = sessionStorage.getItem('applyurl');
					var allowpowerurl = sessionStorage.getItem('allowpowerurl');
		...
		methods: {
            ...
            e.preventDefault()//非IE浏览器
				...
				if(e.currentTarget.dataset.index==0){
					Lay.WeAdminEdit('关于甘肃担保','#layer111',null,1,1)
			...
			aftersuccess(file) {
				...
				// that.href3 = file.body.url_0;
				$('.previe3').attr('href',file.body.url_0);
				$('.previe3').show();
			 ...
			 load_layer() {
				...
				var params;
				 var com = sessionStorage.getItem('companyname')
				  ...
				  that.$store.state.companyname = conmpany[0];
				  that.companyname = that.$store.state.companyname;
				  var companycode = conmpany[1];
				// var resualt2 = await this.$fun.fn("get", that.$store.state.Api3+"/ApplyInfo/companyNameForMore?companyName="+that.companyname, params, that,that.$store.state.Api3)
				var resualt2;
				// companycode = 'GS66102016000484';
				that.$axios.get('/ApplyInfo/companyNameForMore?usbKeySerialNumber='+companycode,{
						...
						layui.use(['layer'], function() {
						 ...
						 // window.location.href = "https://excashier.alipay.com/standard/auth.htm?payOrderId=b9a419c2bfae4d549a5c0a3e0671e3e4.40"
							...
							if (resualt2.data.status == 1){
								...
								layer.msg('未查询到企业信息，请插入Ukey或重装驱动后重试');
							}
						})
			...
			_href1() {
				window.location.href = "http://www.jian-yi.com"
			},
			async changeBorder(e) {
				var that = this;
				var index = e.currentTarget.dataset.index;
				$("input[data-index^='"+index+"']").attr("checked",'checked');
				// $(".yz:eq("+index+")").attr("checked",'checked');
				// $('.yz').attr("checked",'checked')
				if (index == 0) {
					that.address = '邮寄';
					that.Name = '甘肃';
					that.phone = '0931-4917179';

					
				} else if (index == 1) {
					that.address = '邮箱';
					that.Name = '瀚华';
					that.phone = '0931-8418302 18152149071';
				...
				var resualt2 = await this.$fun.fn("get", that.$store.state.Api3+"/ApplyInfo/dzbhMoney?marginAmount=" + that.field1.marginAmount, params,that,that.$store.state.tokenId)
			...
			signOnline(e) {
				...
				this.$axios.post(that.$store.state.Api3+'/ApplyInfo/createPDF', params2,
				{
					...
					.then(res => {
						...
						/* var applyurl2 = localStorage.getItem('applyurl');
						console.log(applyurl2){ */
						if(res.data.status==1){
							if(cateid == 0){
								that.href1 =  sessionStorage.getItem('applyurl');
							}else if(cateid == 1){
								that.href2 =  sessionStorage.getItem('allowpowerurl');
							}
