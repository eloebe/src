	...
	Date.fromString=function(t){
		...
		for(var h=0;h<e.length;h++){
			...
			switch(e[h]){
				...
				break;
				case"M":for(var g=0;g<Date.abbrMonthNames.length;g++){
...
(function(d){
	...
	d.extend(a.prototype,{
		...
		,setStartDate:function(e){
			...
			if(!this.startDate){
				this.startDate=(new Date("12/31/1900"))
			}
	...
	d.dpText={
		TEXT_PREV_YEAR:"上一年",TEXT_PREV_MONTH:"上个月",TEXT_NEXT_YEAR:"下一年",TEXT_NEXT_MONTH:"下个月",TEXT_CLOSE:"关闭",TEXT_CHOOSE_DATE:"选择日期",HEADER_FORMAT:"mmmm yyyy"
	};
